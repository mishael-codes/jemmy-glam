...
export function Hero({ onOpenPriceList }: { onOpenPriceList?: () => void }) {
  return (
    <section className=" min-h-screen pt-24 md:pt-32 pb-16 md:pb-24 overflow-hidden flex flex-col justify-center">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <ScrollReveal animation="fade-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                href="#contact"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-primary text-primary-foreground font-semibold rounded-full hover:bg-primary/90 transition-all hover:scale-105 animate-bounce"
              >
